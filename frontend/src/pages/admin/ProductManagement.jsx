...
const ProductManagement = () => {
  ...
  const [productType, setProductType] = useState("standalone"); // "standalone" or "variant"
  ...
  const [formData, setFormData] = useState({
    ...
    price: "",
    discount: "",
    descriptions: [""], // Array of descriptions, starts with 1 empty
    images: [],
    categoryIds: [],
    subCategoryIds: [],
    collectionIds: [],
  ...
  const handleSubmit = async (e) => {
    ...
    // Basic validation - backend handles detailed validation
    ...
    try {
      // Filter out empty descriptions and map to description1, description2, description3
      ...
      if (dialogMode === "edit" && selectedProduct) {
        ...
        if (response.success) {
          toast.success(response.message || "Product updated successfully", {
            description: `The product "${response.product.productName}" has been updated.`,
          });
        ...
        if (response.success) {
          toast.success(response.message || "Product created successfully", {
            description: `The product "${response.product.productName}" has been added.`,
          });
          handleDialogClose(false);
        }
      }
  ...
  const handleEdit = (product) => {
    ...
    // Build descriptions array from existing description1, description2, description3
    const existingDescriptions = [
      product.description1 || "",
      product.description2 || "",
      product.description3 || "",
    ].filter((d) => d); // Remove empty ones
    ...
    // Store existing images in formData for editing (as objects with publicId and url)
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast.success(response.message || "Product deleted successfully", {
        description: `The product "${selectedProduct.productName}" has been removed.`,
      });
